    ...
    return (
        <div className='flex lg:justify-evenly justify-between px-7 lg:mb-0 mb-9 items-center min-w-full relative'>
            ...
            <div>
                ...
                {/* /////////////////////////////////NAV MOBILE//////////////////////////////////// */}
                <nav className={`lg:hidden ${menuState ? 'block' : 'hidden'} flex absolute top-16 right-7  bg-white min-h-[300px] min-w-[85%] justify-center rounded-[4px] specialBackground z-50`}>
